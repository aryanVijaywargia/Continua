...
func (q *Queries) CountTraces(ctx context.Context, projectFilterID pgtype.UUID) (int64, error) {
	row := q.db.QueryRow(ctx, countTraces, projectFilterID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CountTracesBySession(ctx context.Context, arg CountTracesBySessionParams) (int64, error) {
	row := q.db.QueryRow(ctx, countTracesBySession, arg.SessionID, arg.ProjectFilterID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) GetTrace(ctx context.Context, arg GetTraceParams) (GetTraceRow, error) {
	row := q.db.QueryRow(ctx, getTrace, arg.ID, arg.ProjectFilterID)
	var i GetTraceRow
	err := row.Scan(
		&i.Trace.ID,
		&i.Trace.ProjectID,
...
func (q *Queries) ListTraces(ctx context.Context, arg ListTracesParams) ([]ListTracesRow, error) {
	rows, err := q.db.Query(ctx, listTraces, arg.ProjectFilterID, arg.Offset, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListTracesAsc(ctx context.Context, arg ListTracesAscParams) ([]ListTracesAscRow, error) {
	rows, err := q.db.Query(ctx, listTracesAsc, arg.ProjectFilterID, arg.Offset, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()

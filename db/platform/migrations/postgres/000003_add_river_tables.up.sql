-- =============================================================================
-- River Job Queue Tables (vendored from github.com/riverqueue/river v0.30.0)
-- Consolidated migrations 001-006 into a single migration for Continua
-- =============================================================================
...
-- Mark River migrations as complete (versions 1-6)
INSERT INTO river_migration (line, version, created_at) VALUES
    ('main', 1, NOW()),
    ('main', 2, NOW()),
    ('main', 3, NOW()),
    ('main', 4, NOW()),

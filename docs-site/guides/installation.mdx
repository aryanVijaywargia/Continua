...
| `INGEST_DEPENDENCY_RETRY_WINDOW` | Retry window for async batches waiting on dependencies |
| `INGEST_FAILED_PAYLOAD_RETENTION` | Retention window for failed async ingest payloads |

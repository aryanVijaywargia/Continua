...
export const SESSION_COMPARE: SessionCompareResponse = {
  session: {
    id: SESSION_ID,
    external_id: SESSION_EXTERNAL_ID,
    name: 'Checkout Session',
  ...
  summary: {
    ...
    matched_spans: 1,
    unmatched_baseline_spans: 0,
    unmatched_candidate_spans: 1,
    heuristic_matches: 0,
    duration_delta_ms: -1000,
    tokens_in_delta: 100,
    tokens_out_delta: 70,
    cost_delta_usd: 0.11,
    total_semantic_baseline: 1,
    total_semantic_candidate: 2,
  },
  span_diffs: [
    {
      diff_status: 'changed',
      match_source: 'stable_id',
      match_reason: 'exact_span_id',
      changed_fields: ['tokens_in', 'tokens_out', 'cost_usd'],
      baseline_span: {
        id: 'compare-span-baseline',
        span_id: 'shared-span',
        name: 'Plan',
        kind: 'AGENT',
        status: 'COMPLETED',
        started_at: '2026-03-14T09:00:00.000Z',
        ended_at: '2026-03-14T09:00:02.000Z',
        latency_ms: 2000,
        tokens_in: 10,
        tokens_out: 5,
        cost_usd: 0.01,
      ...
      candidate_span: {
        ...
        tokens_out: 7,
        cost_usd: 0.02,
        error_message: 'Failure detected',
      },
      semantic_groups: [
        {
          event_type: 'decision',
          ...
          match_reason: 'unique_normalized_question',
          changed_fields: ['chosen'],
          baseline_event: {
    ...
    },
    {
      ...
      baseline_span: null,
      candidate_span: {
        id: 'compare-span-candidate-only',
        span_id: 'candidate-only-span',
        parent_span_id: 'shared-span',
        name: 'Retry Tool',
        kind: 'TOOL',
        status: 'COMPLETED',
        started_at: '2026-03-14T10:00:04.000Z',
      ...
      semantic_groups: [
        {
          ...
          baseline_event: null,
          candidate_event: {
            id: 'effect-candidate-only',
            span_id: 'candidate-only-span',
            span_name: 'Retry Tool',
            event_type: 'effect',
            timestamp: '2026-03-14T10:00:04.500Z',
            message: 'Called retry tool',
            payload: {
              effect_id: 'effect-1',
            },
          },

    ...
    >
      ...
      <div className="relative z-[60] flex items-center justify-center gap-3 overflow-hidden bg-secondary-container px-6 py-2.5 text-on-secondary-container">
        ...
        <span className="text-sm font-semibold tracking-tight">
          Agentic Engine secures $12.2M Series A to redefine durable computing.
        </span>
      ...
      <nav className="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <div className="hidden items-center gap-10 md:flex">
            <a
              className="border-b-2 border-zinc-900 pb-1 font-bold tracking-tight text-zinc-900"
              href="#"
            >
              Product
            </a>
      ...
      <main className="pt-24">
        ...
        <section className="mx-auto flex max-w-7xl flex-col items-center px-6 py-20 text-center md:py-32">
          ...
          <h1 className="tight-headline mb-8 max-w-5xl text-5xl font-black text-on-surface md:text-8xl">
            Build and deploy{' '}
            <span className="inline-block -rotate-1 bg-primary-container px-4 py-1 text-white">
              fully-managed
            </span>{' '}
            AI agents.
          </h1>
          <p className="mb-12 max-w-3xl text-lg font-medium leading-relaxed text-on-surface-variant md:text-2xl">
            The durable execution engine designed for the next generation of
            autonomous workflows. Immortal code that survives restarts and
            network failures.
          </p>
              ...
              <div className="flex border-b border-outline-variant/10">
                {CODE_TABS.map((tab, i) => (
                  <button
                    ...
                    className={`border-b-2 px-6 py-4 text-sm font-bold transition-all ${
                      activeTab === i
            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-12 px-6 md:flex-row">
              <div className="max-w-xl">
                ...
                <p className="mb-8 text-lg text-zinc-400">
                  Agentic Engine is Apache 2.0 licensed. Self-host it or use our
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 md:flex-row">
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-zinc-500">
              &copy; 2024 Agentic Durable Execution Engine. Built for technical
              precision.
            </p>
          </div>
